...
public class Assemble {
    ...
    public static void Execute(String result) {
...
//				String Index1 = Index_Select.toString();
			...
			case 3:
				...
				StringBuffer Index_Modify = QuerySpecifiedIndex(sheetIndex, result1[4], Integer.valueOf(result1[5]), result1[6] );
...
//                e.printStackTrace();
    ...
    private static void createTalbe(String tableName, String filedName) {
    	try {
    		while(true) {
    			boolean readFileSuccess = readDataFromFile();
                if (!readFileSuccess) continue;
